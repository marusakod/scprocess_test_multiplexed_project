...
knitr::opts_chunk$set(
  ...
  fig.path = "figure/test_ambient.Rmd/", message = FALSE, warning = FALSE
  )
knitr::opts_knit$set(root.dir = '..', base.dir = '../public/', base.url = '')
# workflowr::wflow_build(files='analysis/test_ambient.Rmd', view=F, verbose=T, delete_cache=F)
```
...
map_dir     = 'output/test_mapping'
amb_dir     = 'output/test_ambient'
stats_f     = "/pmount/projects/site/pred/neurogenomics/users/macnairw/test_multiplexed_project/output/test_ambient/ambient_run_statistics_test_multiplexed_project_2026-01-01.csv"
